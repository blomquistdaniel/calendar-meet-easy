    ...
    <div className="relative">
      <button
        ...
        className={cn(
          ...
          "absolute left-1 top-[13px] h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 z-10"
        )}
      ...
      <button
        ...
        className={cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-1 top-[13px] h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 z-10"
        )}
